				...
				<li class="nav-item dropdown ml-auto"><a id="userInfo" href="#"
					...
					<div aria-labelledby="userInfo" class="dropdown-menu">
						<a href="#" class="dropdown-item"><strong
							class="d-block text-uppercase headings-font-family">${pageContext.request.userPrincipal.name}</strong><small>Role_User</small></a>
	...
	<div class="d-flex align-items-stretch">
							...
							<li class="sidebar-list-item"><a href="#dropdown-lvl2"
								...
								<div id="dropdown-lvl2" class="collapse">
									<ul class="idebar-menu list-unstyled">
										<li class="sidebar-list-item"><a href="#"
											class="sidebar-link text-muted subLv" id="retail">Bán lẻ</a></li>
										<li class="sidebar-list-item"><a href="#"
											class="sidebar-link text-muted subLv" id="soldPrescription">Bán
												theo đơn</a></li>
										<li class="sidebar-list-item"><a href="#"
											class="sidebar-link text-muted subLv" id="wholesale">Bán
												sỉ</a></li>
										<li class="sidebar-list-item"><a href="#"
		...
		<div class="page-holder w-100 d-flex flex-wrap" id="contentRight">
			<iframe src="managementSale" id="sale"
				style="overflow: hidden; border: none;" width="100%"></iframe>
		</div>
