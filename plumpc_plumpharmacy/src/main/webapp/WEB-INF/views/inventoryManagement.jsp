...
<body>
	<form action="">
		<div class="page-holder w-100 d-flex flex-wrap invenMana">
			<div class="container-fluid px-xl-2">
				<section class="py-2">
					<div class="col-lg-12 mb-5">
						<div class="card">
							<div class="card-header">
								<h3 class="h6 text-uppercase mb-0">QUẢN LÝ NHẬP KHO</h3>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-md-3">
										<div class="form-group">
											<label class="form-control-label">Từ ngày: </label> <input
												type="date" class="form-control" id="datepicker1" onblur="timecompare();">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label class="form-control-label">Từ giờ: </label> <input
												type="time" class="form-control" id="timepicker1" onblur="timecompare();">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label class="form-control-label">Sắp xếp theo: </label> <select
												...
												<option value="1">Ngày lập</option>
												<option value="2">Mã HĐ</option>
												<option value="3">Số CT</option>
							...
							<div class="modal-footer">
								<div class="form-group">
									<button type="button" onclick="openReceipt()"
										...
										<i class="fa fa-plus iconFunc"></i>Thêm hóa đơn nhập kho
									</button>
								</div>
							</div>
						</div>
