					...
					<div class="col-lg-12 mb-5">
						<div class="card">
							<div class="card-header">
								<h3 class="h6 text-uppercase mb-0">Khách hoàn trả</h3>
							</div>
							<!--Bộ lọc-->
							<div class="card-body">
								<div class="row justify-content-center">
									<div class="col-md-3">
										<div class="form-group">
											<label class="form-control-label">Tìm hóa đơn: </label> <input
												type="text" class="form-control" id="keywordOrder"
												value="HDBS0001">
										</div>
									</div>
									<div class="col-md-1">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label class="form-control-label">Loại hóa đơn: </label> <input
								...
								<div class="row justify-content-center">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label class="form-control-label">Khách hàng: </label> <input
												type="text" class="form-control">
										</div>
									</div>
								</div>
