...
public class ExcelViewNhapThem extends AbstractXlsxView {
	private static final String[] header = {"Tên thuốc", "Nhóm thuốc", "Giá nhập", "Giá bán lẻ", "Giá bán sỉ", "Nhà sản xuất", "Xuất xứ", "Nhà cung cấp","Số lượng còn lại"};
